...
public class Homework1 {
    ...
    public boolean streamPipeline1(){
        countries.stream().anyMatch(country -> country.getName().startsWith("island"));
    ...
    public Optional<String> streamPipeline2(){
        countries.stream().filter(country -> country.getName().startsWith("island")).findFirst();
    ...
    public void streamPipeline4() {
       countries.stream().mapToLong(Country::getPopulation).sorted().
    ...
    public void streamPipeline5() {
        countries.stream().sorted(Comparator.comparingLong(Country::getPopulation)).limit(10).
	map(Country::getName).
	  forEach(System.out::println);
    }
